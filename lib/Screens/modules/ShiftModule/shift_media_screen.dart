...
/// Result returned from the shift media screen.
class ShiftMediaResult {
...
/// Controller for capturing shift media (photos + video).
class ShiftMediaController extends GetxController {
  ...
  // Vehicle condition flags for shift media
...
/// Screen shown for capturing shift media (pickup or completion).
class ShiftMediaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ShiftMediaController controller = Get.put(ShiftMediaController());
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: MediaCaptureView(
          ...
          parkingNotesController: null, // No notes for shift
          // Shift capture must be from camera only
